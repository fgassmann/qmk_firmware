...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_TEX_ACTIVE] = LAYOUT(
      ...
      OSL(_TEX),_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          TO(_BASE_CODE),
  ...
  OSL(_TEX_ACTIVE),_TEX_a_,_TEX_s_, _TEX_d_, _TEX_f_, _TEX_g_, _TEX_h_, _TEX_j_, _TEX_k_, _TEX_l_, _______, _______, _______, _TEX_ENT,         _______,
